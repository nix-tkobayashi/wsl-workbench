...
const translations = {
  en: {
    ...
    'editor.previewTabHint': 'Preview — the next file you click opens here. Double-click the file or this tab to keep it open.',
  ...
  ja: {
    ...
    'editor.previewTabHint': 'プレビュー — 次にクリックしたファイルはこのタブに表示されます。ファイルかこのタブをダブルクリックで開いたままにします。',
